 ...
 * @author X1 Carbon
 */
public class StoreHelper implements ICallback {
    ...
    private InternetPacket dropTable(String jsonValue) {
        ...
        InternetPacket resPacket = new InternetPacket();
    ...
    private InternetPacket countTable(String jsonValue) {
        String dbName = JsonObject.readFrom(jsonValue).getString("dbName", "");
        String tableName = JsonObject.readFrom(jsonValue).getString("tableName", "");
        Warehouse warehouse = LocalStore.getWarehouse(dbName);
    ...
    private InternetPacket close(String dbName) {
        Warehouse warehouse = LocalStore.getWarehouse(dbName);
        warehouse.close();
        return InternetPacket.getUnknowPacket();
    }
     ...
     * @return
     */
    private InternetPacket createTable(String jsonValue) {
     ...
     * @return
     */
    private InternetPacket insertOne(String jsonValue) {
        String resp = "empty";
        int id = -1;
        try {
            // 1. Parse information.
    ...
    private InternetPacket insertMany(String jsonValue) {
        String resp;
    ...
    private InternetPacket selectOne(String jsonValue) {
        // 1. Parse information.
        String dbName = JsonObject.readFrom(jsonValue).getString("dbName", "");
        String tableName = JsonObject.readFrom(jsonValue).getString("tableName", "");
    ...
    private InternetPacket selectMany(String jsonValue) {
        // 1. Parse information.
        String dbName = JsonObject.readFrom(jsonValue).getString("dbName", "");
        String tableName = JsonObject.readFrom(jsonValue).getString("tableName", "");
