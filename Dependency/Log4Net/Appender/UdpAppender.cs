...
namespace log4net.Appender 
{
	...
	public class UdpAppender : AppenderSkeleton
	{
		...
		public override void ActivateOptions()
		{
			...
			{
				throw SystemInfo.CreateArgumentOutOfRangeException("this.RemotePort", (object)RemotePort,
			...
			{
				throw SystemInfo.CreateArgumentOutOfRangeException("this.LocalPort", (object)LocalPort,
