...
namespace log4net.Util
{
	...
	public sealed class ThreadContextProperties : ContextPropertiesBase
	{
		...
		/// </summary>
		private readonly static LocalDataStoreSlot s_threadLocalSlot = Thread.AllocateDataSlot();
		...
		{
			PropertiesDictionary properties = (PropertiesDictionary)Thread.GetData(s_threadLocalSlot);
